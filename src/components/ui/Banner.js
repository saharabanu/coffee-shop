        ...
        <div className="lg:flex justify-between items-center ">
          ...
          >
            <SwiperSlide>
              {" "}
              <div>
                <h5 className="font-lemon">WELCOME TO OUR</h5>
                <h1 className=" font-sanspro  font-bold py-4 text-6xl">
                  Unlocklive
                </h1>
                <h2 className="banner-heading2 font-baklida text-3xl py-2">
                ...
                <div className="flex items-center space-x-10 pt-5">
                   ...
                   <div>
                    <h2 className="font-bold text-2xl font-baklida">1200+</h2>
